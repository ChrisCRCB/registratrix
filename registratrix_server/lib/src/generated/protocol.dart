...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i5.Organisation) {
      return _i5.Organisation.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i5.Organisation?>()) {
      return (data != null ? _i5.Organisation.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'Organisation') {
      return deserialize<_i5.Organisation>(data['data']);
    }
